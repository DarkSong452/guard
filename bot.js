...
client.on('ready', async () => {
 ...
 client.user.setActivity(`Dark Dést ♥ Gökmen`, { type:'WATCHING' })
  
  console.log("Dark Dést Akıyor!!")
});
...
client.on("message",message=>{ if(message.content==`<@!${client.user.id}>`) return message.channel.send(`**Prefixim :  d. | Guard Komutlarım Vardır**`); })
